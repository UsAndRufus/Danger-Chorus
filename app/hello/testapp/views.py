...
<head>
 ...
 <body>
    ...
    <div id = 'content'>
    <div id = 'heading'>
<h1 class='title'>Danger Chorus</h1>
    </div>
    <div id = 'scroll'>
   <ul class="a">
   ...
   <div id = 'listen'>
        <section id="play">
            ...
            <input type = 'radio' name = 'select' value = '4' id ='select'> Description
            </br>
            </br>
            <div class = '2button'>
...
#it also sets the layout and colour for the display page. its also where the sound is played and the buttons are displayed    
...
# this tells where it should look for the animal image,also because it creates an error when it doesnt find an image i put a try statement in so that it just displays just the information about the animal  
   try:
